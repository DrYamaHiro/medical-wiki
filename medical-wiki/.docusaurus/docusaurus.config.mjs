...
export default {
  ...
  "organizationName": "dryamahiro",
  "projectName": "medical-wiki",
  "onBrokenLinks": "warn",
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/dryamahiro/medical-wiki/tree/main/",
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 Medical Knowledge Wiki. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
