...
export const LIFESTYLE_OPTIONS = [
  { id: 'lifestyle_diet',                     label: '🍱 食事療法のみ',           description: '重度整形/心不全代償破綻/運動絶対禁忌の場合' },
  { id: 'lifestyle_diet_exercise',            label: '🍱+🏃 食事+運動療法',      description: '通常 (default)' },
  { id: 'lifestyle_diet_exercise_restricted', label: '🍱+🏃⚠ 食事+運動 [制限考慮]', description: '整形/心血管/呼吸器/腎/フレイル等で運動制限あり' },
];
...
export const LIFESTYLE_RESTRICTION_REASONS = [
  ...
  { id: 'other',         label: '📝 その他 (note記載)', description: '自由記載' },
];
