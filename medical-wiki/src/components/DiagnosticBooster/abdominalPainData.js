...
export const DIFFERENTIALS = [
  ...
  },
  {
    ...
    severityWeight: 4,
    resolvedStillDangerous: true,
    requiresPatient: { pregnancy: 'possible' },
  ...
  // === 高頻度疾患 ===
  {
    ...
    patternBonus: { all: ['rlq', 'mcburney'], bonus: 4 },
  ...
  },
  {
    ...
    findings: ['epigastric_tenderness'],
    negativeFindings: ['murphy_sign', 'mcburney', 'cva_tenderness'],
    redFlags: [],
  ...
  },
  {
    ...
    findings: [],
    negativeFindings: ['murphy_sign', 'mcburney', 'duration_chronic', 'weight_loss', 'night_sweats'],
    redFlags: [],
  ...
  },
  {
    ...
    negativeFindings: ['murphy_sign', 'mcburney'],
    redFlags: [],
  ...
  },
  {
    ...
    findings: [],
    negativeFindings: ['fever', 'diarrhea', 'murphy_sign', 'mcburney', 'peritoneal_signs', 'weight_loss'],
    redFlags: [],
  ...
  },
  {
    ...
    findings: [],
    negativeFindings: ['fever', 'weight_loss', 'bloody_stool', 'duration_chronic', 'murphy_sign', 'mcburney', 'peritoneal_signs', 'cva_tenderness'],
    redFlags: [],
