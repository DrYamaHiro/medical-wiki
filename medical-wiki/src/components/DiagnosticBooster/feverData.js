...
export const DIFFERENTIALS = [
  {
    ...
    prevalenceWeight: 10,
    severityWeight: 1,
    symptoms: ['sore_throat', 'cough', 'rhinorrhea', 'headache', 'duration_acute'],
    findings: [],
    negativeFindings: ['duration_chronic', 'pel_ebstein'],
    redFlags: [],
  ...
  },
  {
    ...
    prevalenceWeight: 8,
    severityWeight: 1,
    symptoms: ['cough', 'headache', 'joint_pain', 'sore_throat', 'rhinorrhea', 'duration_acute'],
    findings: [],
    negativeFindings: ['duration_chronic', 'pel_ebstein'],
  ...
  },
  {
    ...
    prevalenceWeight: 8,
    severityWeight: 2,
    symptoms: ['cough', 'sore_throat', 'headache', 'dyspnea', 'rhinorrhea', 'duration_acute'],
    findings: [],
    negativeFindings: ['duration_chronic', 'pel_ebstein'],
    redFlags: ['dyspnea'],
  ...
  },
  {
    ...
    prevalenceWeight: 8,
    severityWeight: 2,
    symptoms: ['dysuria', 'flank_pain', 'vomiting', 'abdominal_pain', 'duration_acute'],
    findings: ['cva_tenderness'],
    negativeFindings: ['duration_chronic'],
  ...
  },
  {
    ...
    prevalenceWeight: 8,
    severityWeight: 2,
    symptoms: ['skin_redness', 'duration_acute'],
