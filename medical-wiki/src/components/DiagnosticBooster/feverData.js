...
export const SYMPTOMS = [
  ...
  { id: 'pel_ebstein', label: 'Pel-Ebstein型 (周期性反復熱、リンパ腫示唆)', cat: '発熱パターン', weight: 4 },
  // Phase 4.1: 持続期間
...
export const DIFFERENTIALS = [
  ...
  },
  {
    ...
    severityWeight: 4,
    resolvedStillDangerous: true,
    symptoms: ['fever', 'headache', 'travel_history', 'intermittent_fever', 'continuous_fever'],
    findings: ['splenomegaly'],
    redFlags: ['travel_history'],
    nextStep: '熱帯・亜熱帯地域からの帰国者の発熱は必ず疑う。即日 感染症内科/熱帯医学施設へ紹介。血液塗抹 (Giemsa染色) で virus 同定。P. falciparum は重症化進行性 → 24時間以内の治療開始が rule。',
    link: null,
