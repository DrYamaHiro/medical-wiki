...
export const DIFFERENTIALS = [
  {
    ...
    showWhen: { anyOf: ['cough', 'sore_throat', 'rhinorrhea', 'duration_acute', 'duration_subacute'] },
    redFlags: [],
  ...
  },
  {
    ...
    showWhen: { anyOf: ['cough', 'sore_throat', 'rhinorrhea', 'duration_acute'] },
  ...
  },
  {
    ...
    findings: [],
    negativeFindings: ['duration_chronic', 'pel_ebstein', 'neck_stiffness', 'meningeal_signs', 'dysuria', 'flank_pain', 'cva_tenderness', 'diarrhea', 'travel_history', 'intermittent_fever', 'relapsing_fever', 'new_murmur', 'rash'],
    showWhen: { anyOf: ['cough', 'sore_throat', 'rhinorrhea', 'dyspnea', 'duration_acute'] },
    redFlags: ['dyspnea'],
