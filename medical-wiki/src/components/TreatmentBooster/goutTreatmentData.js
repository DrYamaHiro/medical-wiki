...
export const RECOMMENDATIONS = [
  ...
  {
    id: 'add_colchicine_prophylaxis_at_ult_start',
    action: 'STEP_UP',
    drug: '🛡 コルヒチン予防併用（尿酸降下薬 開始期 3-6ヶ月）',
    example: 'コルヒチン錠 0.5mg 1日1回（朝 or 就寝前）× 3-6ヶ月',
    reason: 'ULT開始期は SUA急変動で flare誘発リスク。GL推奨の予防併用で発作頻度が約半減',
    fromStates: ['mono', 'dual'],
    preferredWhen: ['cm_gout_attack_hx', 'cm_tophi_present', 'cm_urate_production_high'],
    forbidden: ['cm_ckd_g45', 'co_pregnancy', 'co_strong_cyp3a4_inhibitor'],
    avoidWhen: ['cm_ckd', 'cm_liver_severe', 'fh_colchicine_intolerance', 'se_colchicine_gi'],
    reassess: '3ヶ月後に発作頻度評価、SUA<6達成 + 6ヶ月以上発作なしで中止検討',
    note: '【ULT開始期 flare予防】SUA低下時の関節結晶離脱で flare誘発。GL推奨期間 3-6ヶ月、SUA<6 達成 + 6ヶ月発作なしで中止可。CKDではNSAID/低用量PSL（5-10mg/日）も代替候補。コルヒチン+CYP3A4阻害（クラリスロマイシン等）は致死的相互作用で禁忌',
  },
  {
