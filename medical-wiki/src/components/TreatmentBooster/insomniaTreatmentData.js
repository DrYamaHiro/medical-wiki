...
export const RECOMMENDATIONS = [
  ...
  },
  {
    ...
    example: 'リフレックス 15mg 就寝前',
    reason: '鎮静作用強く、うつと不眠の一石二鳥。食欲低下も改善',
...
export const DO_NOT_RULES = [
  ...
  },
  {
    drug: 'ラメルテオン',
    modifiers: [],
    reason: 'フルボキサミン併用禁忌（CYP1A2阻害で血中濃度急上昇）',
  },
  {
    drug: 'トリアゾラム（ハルシオン）',
    modifiers: ['co_elderly_75', 'fh_bz_dependence'],
    reason: '【禁忌級】超短時間型で依存・健忘・奇異反応強い。高齢者回避',
  },
];
