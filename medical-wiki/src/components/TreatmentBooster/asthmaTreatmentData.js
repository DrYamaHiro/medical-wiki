...
export const MODIFIERS = [
  ...
  { id: 'cm_chronic_urticaria', label: '慢性蕁麻疹（H1拮抗薬高用量で未制御）', cat: '併存疾患' },
  { id: 'cm_atopic_dermatitis', label: 'アトピー性皮膚炎（中等症以上）', cat: '併存疾患' },
...
export const RECOMMENDATIONS = [
  ...
  {
    id: 'omalizumab_dual_indication_urticaria',
    action: 'REFER',
    drug: '🎯 オマリズマブ dual適応（喘息+慢性蕁麻疹）',
    reason: '喘息+慢性蕁麻疹で1剤同時治療可能、適応取得済み',
    fromStates: ['triple', 'quad_plus', 'mono', 'dual'],
    preferredWhen: ['cm_chronic_urticaria'],
    specialistGate: true,
    note: '【dual適応】喘息（IgE適応）+ 慢性特発性蕁麻疹（H1拮抗薬高用量で未制御）の両方でゾレアが適応取得済み。1剤で同時治療できる稀少例。皮膚科 ↔ 呼吸器の連携で導入。',
  },
  {
    id: 'dupilumab_dual_indication_atopy',
    action: 'REFER',
    drug: '🎯 デュピルマブ dual適応（喘息+アトピー性皮膚炎/鼻茸）',
    reason: 'Type2炎症性疾患の dual/triple 適応（喘息+AD+鼻茸+EoE）',
    fromStates: ['triple', 'quad_plus', 'mono', 'dual'],
    preferredWhen: ['cm_atopic_dermatitis', 'cm_nasal_polyps'],
    specialistGate: true,
    note: '【dual適応】デュピルマブは喘息・アトピー性皮膚炎・好酸球性副鼻腔炎/鼻茸・好酸球性食道炎で適応取得済み。Type2 炎症の併存疾患があれば 1剤で同時治療できる第一選択。皮膚科 ↔ 呼吸器/耳鼻科 連携。',
  },
  {
