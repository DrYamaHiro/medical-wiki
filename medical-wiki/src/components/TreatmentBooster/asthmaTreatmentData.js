...
export const DRUGS = [
  ...
  { id: 'triple_trelegy_L', label: 'トレルジー エリプタ 100（25/62.5/100）',
    class: 'ICS/LABA/LAMA', potency: 'low-medium', device: 'DPI',
    doses: [{ value: '1_qd', label: '1吸入×1回/日', isDefault: true }] },
  { id: 'triple_trelegy_H', label: 'トレルジー エリプタ 200（25/62.5/200）',
    class: 'ICS/LABA/LAMA', potency: 'high', device: 'DPI',
    doses: [{ value: '1_qd', label: '1吸入×1回/日', isDefault: true, isMax: true }] },
  ...
  { id: 'saba_proca', label: 'プロカテロール（メプチン エアー）10μg', class: 'SABA',
    device: 'pMDI',
...
export const RECOMMENDATIONS = [
  ...
  },
  {
    ...
    action: 'SWITCH',
    drug: '2剤 → 単一吸入3剤へ切替',
    example: 'ICS/LABA + LAMA 別々 → エナジア or トレルジー 1日1回',
  ...
  },
  {
    ...
    action: 'DOSE_UP',
    drug: 'Triple 中用量 → 高用量',
    example: 'エナジア中 → エナジア高 / トレルジー100 → 200',
