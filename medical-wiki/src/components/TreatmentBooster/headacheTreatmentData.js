...
export const RECOMMENDATIONS = [
  ...
  // === MOH ===
  {
    ...
    note: '【MOH 離脱プロトコル詳細】\n① 薬剤完全中止（突然 or 漸減）2-4週\n② 離脱期の対症 — プライマリケアでの線引き:\n  ✅ 外来で許容: 制吐 (メトクロプラミド/ドンペリドン経口)、別系統の短期NSAID 1週、軽症リバウンド時のアセトアミノフェン (中止対象でない場合)\n  ⚠ 慎重対応: PSL 30mg×5日 (BZ/オピオイド既往なし、糖尿病なし) — 経験者向け\n  🔴 入院・神経内科紹介: 制吐+輸液で軽快しない、嘔気で経口不可、PSL適応不明、48-72時間以内に頭痛増悪、神経症状出現\n③ 同時に予防薬導入 (プロプラノロール/アミトリプチリン/CGRP抗体)\n④ 4週後評価：頭痛日数50%減なら継続、増悪なら入院・専門医\n⑤ 制限（週2-3回）のみは離脱効果不十分。GL第一は「中止」',
  },
  {
